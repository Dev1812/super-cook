...
class Controller_Main extends Controller {
  ...
  public function action_create_food() {
    ...
    $param = array();
    $param['page_title'] = 'Добро пожаловать | '.SITE_NAME;
    //$data['foods'] = $this->model->getFoodInfo($_GET['food_id']);
...
/*
  ...
  createFood($_POST['create_food_title'],$_POST['create_food_description']);
  }
*/
if(!empty($_POST['create_food_submit'])) {
...
//print "</pre>";
  ...
  public function action_ajax_delete_my_post() {
    $data = array();
    $param = array();
    /*if(!isset($_POST['target_id']) || !isset($_POST['text'])) {
      $data['ajax'] =array('is_error'=>true);
    } else {*/
